...
| **SQL Injection**                           |   Beginner   | Manipulate relational database queries due to a lack of server-side input sanitization.               | On Progress                                          |
| **Cross-Site Scripting (XSS)**              |   Beginner   | Inject malicious JavaScript (Reflected & Stored) to be executed in the victim's browser.              | Completed ([Writeup](docs/writeups/XSS.md))          |
